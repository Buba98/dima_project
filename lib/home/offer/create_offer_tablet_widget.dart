...
class CreateOfferTabletWidget extends StatefulWidget {
  const CreateOfferTabletWidget({super.key});

  @override
  _CreateOfferTabletWidgetState createState() =>
      _CreateOfferTabletWidgetState();
}

class _CreateOfferTabletWidgetState extends State<CreateOfferTabletWidget> {
  double? price;
        ...
        children: [
          SizedBox(
            ...
            child: ListView(children: [
              ...
              const SizedBox(
                height: 50,//TODO expand to move confirm_button to end
              ),
              Center(
                child: Button(onPressed: (){}, text: 'Confirm'),//TODO onPressed
              ),
            ]),
          ),
          SizedBox(
