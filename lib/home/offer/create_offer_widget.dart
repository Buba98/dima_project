...
class CreateOfferWidget extends StatefulWidget {
  ...
  @override
  _CreateOfferWidgetState createState() =>
      _CreateOfferWidgetState();
}
...
class _CreateOfferWidgetState extends State<CreateOfferWidget> {
          ...
          children: [
            SizedBox(
              ...
              child: ListView(children: [
                ...
                Center(
                  child: Button(
                      onPressed: () {}, text: 'Confirm'), //TODO onPressed
                ),
              ]),
            ),
            SizedBox(
  ...
  List<Widget> _fixedWidgets() {
    List<Widget> widgets = [
      ...
      ElevatedButton(onPressed: () => {}, child: Text('location placeholder')),
      const SizedBox(
        height: 15,
      ),
      Row(
